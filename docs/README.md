...
- [Architecture.md](Architecture.md) for the documentation structure and change rules.
- [00-documentation-standards.md](00-documentation-standards.md) for writing and maintenance rules.
- [00-source-of-truth.md](00-source-of-truth.md) for canonical ownership.
- [INDEX.md](INDEX.md) for the navigation map.
...
When the documentation structure changes, update this file together with [Architecture.md](Architecture.md), [00-documentation-standards.md](00-documentation-standards.md), [00-source-of-truth.md](00-source-of-truth.md), and [INDEX.md](INDEX.md).
