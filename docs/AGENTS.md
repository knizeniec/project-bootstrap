...
- Keep `docs/project/adr/` as the only exception to root numbered-area ownership. New ADRs should start from `docs/project/adr/ADR-000-template.md` and follow `docs/project/adr/README.md`.
...
- Treat `docs/project/` as ADR-only support space.
