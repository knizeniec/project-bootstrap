<!-- Context: project-intelligence/navigation | Priority: high | Version: 1.0 | Updated: 2026-05-07 -->

# Project Intelligence Navigation

**Purpose**: Fast entry points into the local Project Intelligence context for this repository.
**Last Updated**: 2026-05-07

## Quick Routes
| File | Description | Priority |
| --- | --- | --- |
| `technical-domain.md` | Technical stack, naming patterns, standards, and security expectations | critical |
