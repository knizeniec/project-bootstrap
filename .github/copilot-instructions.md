...
- Start with `AGENTS.md` and `README.md` for repo-wide workflow and structure.
- This template tracks assistant-native assets in `.claude/`, `.copilot/`, `.codex/`, and `.opencode/`.
